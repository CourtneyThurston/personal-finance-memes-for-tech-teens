...
2. Send via certified mail a letter to the collections agency requesting verification of the validity of the debt. If the debt is valid (they can prove it's yours, it wasn't paid yet, etc), you'll need to pay up to avoid them getting a court judgement against you, where they can garnish your wages, etc. 
